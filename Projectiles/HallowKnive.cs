...
{
    public class HallowKnive : ModProjectile
    {
        public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hallowed Knive");
		}
        ...
        public override void AI()
        {
            ...
            int DustID = Dust.NewDust(projectile.position, projectile.width + 4, projectile.height + 4, 57, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 0, default(Color), 0.75f); //Spawns dust
        ...
        public override void Kill(int timeLeft)
        {
            if (projectile.alpha < 250) {
                ...
                for (int i = 0; i < 20; i++) {
                    int DustID = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 57, (float)rnd.NextDouble()-.5f, (float)rnd.NextDouble()-.5f, 120, default(Color), 0.75f); //Spawns dust
                }
            }
        }
        //----------------------
